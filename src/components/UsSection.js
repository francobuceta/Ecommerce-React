        ...
        <>
            <section className="us_section_bg d-flex align-items-center">
                <div className="container d-flex justify-content-between">
                    <div>
                        <span className="us_font">Aquí</span>
                    </div>
                    <div>
                        <span className="us_font">Sucede</span>
                    </div>
                </div>
            </section>
            <section className="us_section">
                <div className="container us_container">
                    ...
                    <p>Nos encanta este deporte al igual que a vos, y por eso queremos ofrecerte los mejores
                        ...
                        <p>De esta manera decidimos crear nuestro emprendimiento
                        y hemos llegado a conformar una clientela enorme que hace que "Pick & Roll" siga creciendo.
